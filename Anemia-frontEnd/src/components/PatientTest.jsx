...
const PatientTest = () => {
  ...
  const [params, setParams] = useState({
    ...
    eyeImageData: { value: null, valid: false, error: "" },
    nailImageData: { value: null, valid: false, error: "" },
    tongueImageData: { value: null, valid: false, error: "" },
  });
  ...
  const onSubmit = () => {
    ...
    const formData = {
      ...
      eyeImageData: params.eyeImageData.value,
      nailImageData: params.nailImageData.value,
      tongueImageData: params.tongueImageData.value,
  ...
  return (
    <React.Fragment>
      <Link type="button" to={'/ashadashboard'} class=" flex float-end mr-5 my-3 rounded-lg bg-indigo-500 px-6 py-2 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">
        View History
        </Link><br/>
